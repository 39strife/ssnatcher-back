                                    ...
                                    <tr>
                                        <td style="
                                            ...
                                            <p style="
                                                        ...
                                                        margin-bottom: 15px;
                                                    ">
                                                Use the link below or verify your email here: http://splustesting.ga/verification/{{$code ?? "123123"}}
                                            </p>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="
                                                                                    ...
                                                                                    text-align: center;
                                                                                ">
                                                                            <a href="http://splustesting.ga/verification/{{$code ?? '123123'}}" target="_blank" style="
